...
def get_wework_jobs(keyword):
  ...
  jobs=[]
  feature_jobs = driver.find_elements(By.XPATH, '//section[@class="jobs"]/article/ul/li[@class="feature"]/a')
  no_feature_jobs = driver.find_elements(By.XPATH, '//section[@class="jobs"]/article/ul/li[@class=""]/a')
